...
namespace Sitecore.Foundation.SitecoreExtensions.Extensions
{
    ...
    public static class ItemExtensions
    {
        ...
        {
            return !int.TryParse(item.Fields[fieldId].Value, out var result) ? default(int?) : result;
        }
        ...
        public static double? GetDouble(this Item item, ID fieldId)
        {
            ...
            if (double.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out var num) || double.TryParse(value, NumberStyles.Any, CultureInfo.GetCultureInfo("en-US"), out num) || double.TryParse(value, NumberStyles.Any, CultureInfo.CurrentCulture, out num))
            {
                return num;
            }
